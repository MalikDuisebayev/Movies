...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../src/root/root.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ROOT_ROOT = exports.ROOT_MODAL = exports.ROOT_HEADER = void 0;
var ROOT_HEADER = document.querySelector("#header");
exports.ROOT_HEADER = ROOT_HEADER;
var ROOT_ROOT = document.querySelector("#root");
exports.ROOT_ROOT = ROOT_ROOT;
...
var Header = /*#__PURE__*/function () {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      _root.ROOT_HEADER.innerHTML = html;
    }
  }]);
...
},{"../../root/root":"../src/root/root.js","./Header.css":"../src/components/Header/Header.css"}],"../src/components/Header/index.js":[function(require,module,exports) {
"use strict";
...
},{"./Header":"../src/components/Header/Header.js"}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../src/api/getMovies.js":[function(require,module,exports) {
"use strict";
...
var GetMovies = /*#__PURE__*/function () {
  function GetMovies() {
    ...
    this.URL = "https://kinopoiskapiunofficial.tech/api/v2.2/films/premieres?year=2022&month=JULY";
  }

  _createClass(GetMovies, [{
    key: "get",
    value: function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                data = _context.sent;
                return _context.abrupt("return", data.data.items);
...
var _default = new GetMovies();

exports.default = _default;
},{"axios":"../node_modules/axios/index.js"}],"../src/components/Error/Error.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var Error = /*#__PURE__*/function () {
  ...
  _createClass(Error, [{
    ...
    value: function render() {
      ...
      _root.ROOT_ROOT.innerHTML = html;
    }
  }]);
...
exports.default = _default;
},{"../../root/root":"../src/root/root.js","./Error.css":"../src/components/Error/Error.css"}],"../src/components/Error/index.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Error":"../src/components/Error/Error.js"}],"../src/components/Modal/Modal.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var _getMovies = _interopRequireDefault(require("../../api/getMovies"));
...
var Modal = /*#__PURE__*/function () {
  ...
  _createClass(Modal, [{
    key: "getListsMoviesInCategory",
    value: function getListsMoviesInCategory(el, category) {
      var lists = "";

      if (el.length > 1) {
        el.forEach(function (element) {
          lists += "".concat(element[category], " ");
        });
      } else {
        lists = el[0][category];
      }
    ...
    key: "render",
    value: function () {
      var _render = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
        var data, nameRu, nameEn, countries, genres, posterUrl, premiereRu, date, genre, country, htmlCatalog, htmlWrapper;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _getMovies.default.get();

              case 2:
                data = _context.sent.find(function (el) {
                  return el.kinopoiskId == id;
                });
                nameRu = data.nameRu, nameEn = data.nameEn, countries = data.countries, genres = data.genres, posterUrl = data.posterUrl, premiereRu = data.premiereRu;
                date = new Date(premiereRu).toLocaleDateString("ru-RU");
                genre = this.getListsMoviesInCategory(genres, "genre");
                country = this.getListsMoviesInCategory(countries, "country");
                htmlCatalog = "\n    <div class=\"modal__item\"> \n    <img class=\"modal__img\" src=\"".concat(posterUrl, "\" alt=\"").concat(nameRu, "\">\n    <div class=\"modal__content\">\n    <h2 class=\"modal__name\" >\n    ").concat(nameRu, "\n    <span class=\"modal__name-span\">").concat(nameEn, "</span>\n    </h2>\n    <ul class=\"modal__list\">\n        <li class=\"modal__list-item\"><strong>\u0416\u0430\u043D\u0440:</strong> ").concat(genre, "</li>\n        <li class=\"modal__list-item\"><strong>\u0421\u0442\u0440\u0430\u043D\u0430:</strong> ").concat(country, "</li>\n        <li class=\"modal__list-item\"><strong>\u041F\u0440\u0435\u043C\u044C\u0435\u0440\u0430:</strong> ").concat(date, "</li>\n        \n    </ul>\n    </div>\n</div>\n    ");
...
exports.default = _default;
},{"../../api/getMovies":"../src/api/getMovies.js","../../root/root":"../src/root/root.js","./Modal.css":"../src/components/Modal/Modal.css"}],"../src/components/Modal/index.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Modal":"../src/components/Modal/Modal.js"}],"../src/components/Movies/Movies.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/components/Movies/Movies.js":[function(require,module,exports) {
"use strict";
...
var Movies = /*#__PURE__*/function () {
  ...
  _createClass(Movies, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                return _context.abrupt("return", _Error2.default.render());

              case 5:
                htmlCatalog = "";
                data.forEach(function (_ref) {
                  var kinopoiskId = _ref.kinopoiskId,
                      nameRu = _ref.nameRu,
                      posterUrl = _ref.posterUrl;
                  htmlCatalog += "\n            <li class=\"movies__item\" data-id=\"".concat(kinopoiskId, "\">\n                <img class=\"movies__img\" src=\"").concat(posterUrl, "\" alt=\"").concat(nameRu, "\">\n                <span class=\"movies__name\"> ").concat(nameRu, " </span>\n            </li>\n      ");
                });
    ...
    value: function eventListener() {
      ...
      moviesItem.forEach(function (card) {
        card.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
          var id;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 3;
                  return _Modal.default.render(id);
...
var _default = new Movies();

exports.default = _default;
},{"../../api/getMovies":"../src/api/getMovies.js","../../root/root":"../src/root/root.js","../Error":"../src/components/Error/index.js","../Modal":"../src/components/Modal/index.js","./Movies.css":"../src/components/Movies/Movies.css"}],"../src/components/Movies/index.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Movies":"../src/components/Movies/Movies.js"}],"../src/components/App/App.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
      ...
      var _render = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _Header.default.render();

                _context.next = 3;
                return _Movies.default.render();

              case 3:
                _Movies.default.eventListener();
...
exports.default = _default;
},{"../Header":"../src/components/Header/index.js","../Movies":"../src/components/Movies/index.js","./App.css":"../src/components/App/App.css"}],"../src/components/App/index.js":[function(require,module,exports) {
"use strict";
...
},{"./components/App":"../src/components/App/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
